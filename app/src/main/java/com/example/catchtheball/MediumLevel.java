...
public class MediumLevel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orangeSpeed = Math.round(screenWidth / 30.0f); // 768/60 =12.8..... => 13
        pinkSpeed = Math.round(screenWidth / 20.0f);  //768/36/ = 21.333 => 21
        blackSpeed = Math.round(screenWidth / 25.0f); //768/45 = 17.06..... => 17
